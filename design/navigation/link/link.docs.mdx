...
The Link component is built on top of the [Typography](https://bit.cloud/cosmo-flux.design/data-display/typography) component, meaning that you can use its props.
